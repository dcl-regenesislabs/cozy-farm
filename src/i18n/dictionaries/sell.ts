...
export const sellDict: TranslationDictionary = {
  'sell.hover.sellCrops': { en: 'Sell Crops', es: 'Vender Cultivos', pt: 'Vender Plantações' },
  ...
  'sell.emptyBody':  { en: 'Harvest crops or collect eggs first.', es: 'Cosecha cultivos o recolecta huevos primero.', pt: 'Colha plantações ou colete ovos primeiro.' },
}
