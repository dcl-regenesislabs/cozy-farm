  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <OutlineLabel
            value={t('unlock.plotExpansion.title')}
            fontSize={d(24)}
        ...
        {/* Description */}
        <Label
          value={t('unlock.plotGroup.description')}
        ...
        >
          ...
          {minLevel > 0 && (
            ...
            >
              <Label
                value={meetsLevel ? t('unlock.levelMet', { level: minLevel }) : t('unlock.levelRequired', { level: minLevel })}
                fontSize={d(12)}
                color={BTN_TEXT}
