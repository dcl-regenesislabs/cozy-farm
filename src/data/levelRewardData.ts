...
export const LEVEL_REWARDS: LevelReward[] = [
  ...
  { level: 20, type: 'seeds', cropType: CropType.Pumpkin,   amount: 3,    label: '+3 Pumpkin Seeds'   },
  { level: 25, type: 'seeds', cropType: CropType.Sunflower, amount: 3,    label: '+3 Sunflower Seeds' },
]
